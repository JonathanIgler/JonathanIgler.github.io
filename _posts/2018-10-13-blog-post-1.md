...
One of the main reasons of SpaceX`s sucess and records can be resumed in one single point: They are privately funded. Apart from this,  it is possible to see the rapid growth of the company and the missions conducted, as listed below:
...
* Crew dragon 2, *30/03/2020* - Sucessfully delivering manned spacecraft to ISS, recovering booster on ocena platform.

One must notice, that the speed in which sucess and histopry is being made, seems sheerly impossible. In order to analyse the reason for this sucess, we find three points which show the degree of innovation of rocket science:
